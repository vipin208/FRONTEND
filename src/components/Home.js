    ...
    <>
     ...
     <div className='containerr'>
      ...
      <div className='gallery'>
        ...
        <div className='box ' style={{backgroundImage:`url(${css})`}}>css</div>
        ...
        <div className='box ' style={{backgroundImage:`url(${nodejs})`}}>nodejs</div>
        <div className='box' style={{backgroundImage:`url(${expressjs})`}}>expressjs</div>
        <div className='box ' style={{backgroundImage:`url(${mongodb})`}}>mongodb</div>
